...
add_action( 'widgets_init', function () {
	register_widget( 'MMHC_Widget_TextIcon' );
} );

/**
 * Class MMHC_Widget_TextIcon
 *
 * Widget for showing Text boxes with an Icon in the title.
 *
 * @since 1.0.0
 */
class MMHC_Widget_TextIcon extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			'Text with Icon',
			array(
				'description' => 'For use in the MMHC sidebar. Shows text with an icon in the title.',
			)
		);
	}
